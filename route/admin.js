...
router.post(
  '/role',
  isAuth,
  validation.postRoleValidation,
  roleController.postRoleAPI
)
router.get('/role/create', isAuth, roleController.createDataAPI)
router.post(
  '/role/user',
  isAuth,
  validation.roleUserPostValidation,
  roleController.postRoleUserAPI
)
router.put(
  '/role/:roleId',
  isAuth,
...
router.get(
  '/permission-module',
  isAuth,
  permissionModuleController.getPermissionModuleAPI
)
router.post(
  '/permission-module',
  isAuth,
  validation.postPermissionModule,
  permissionModuleController.postPermissionModuleAPI
)
router.put(
  '/permission-module/:permissionId',
  isAuth,
  validation.postPermissionModule,
  permissionModuleController.putPermissionModuleAPI
)
...
router.put(
  '/permission/:permissionModuleId/:permissionId',
  isAuth,
  validation.postPermission,
...
router.post(
  '/package-type',
  isAuth,
  validation.packageTypePostValidation,
  packageTypeController.postPackageType
)
router.put(
  '/package-type/:packageTypeId',
  isAuth,
  validation.packageTypePostValidation,
  packageTypeController.updatePackageTypeAPI
)
...
router.post(
  '/package',
  isAuth,
  validation.postPackageValidation,
  packageAPIController.postPackageAPI
)
router.put(
  '/package/:packageTypeId/:packageId',
  isAuth,
  packageAPIController.putPackageAPI
)
...
router.post(
  '/company',
  isAuth,
  validation.postCompany,
  imageUpload('photo'),
  companyAPIController.postCompanyAPI
)
...
router.delete(
  '/company/:id/delete',
  isAuth,
  companyAPIController.deleteCompanyAPI
)
router.put(
  '/company/:id',
  isAuth,
...
router.put(
  '/designation/:id',
  isAuth,
  designationAPIController.putDesignationAPI
)
router.delete(
  '/designation/:id',
  isAuth,
  designationAPIController.deleteDesignationAPI
)
...
router.post(
  ...
  isAuth,
  uploadVideo('file'),
  ParticipationTypeAPIController.postAPI
)
router.get(
  '/participation_types',
  isAuth,
  ParticipationTypeAPIController.getAPI
)
router.put(
  '/participation_type/:id',
  isAuth,
  uploadVideo('file'),
  ParticipationTypeAPIController.putAPI
)
router.delete(
  '/participation_type/:id',
  isAuth,
  ParticipationTypeAPIController.deleteAPI
)
...
router.get(
  ...
  isAuth,
  permissionController.getPermAllowAPI
)
